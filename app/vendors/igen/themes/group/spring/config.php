...
//colors
define('COLOR_TOP_TITLE','0,80,30'); // top box title color R, G, B
...
define('COLOR_COPYRIGHT','0,0,0'); // text color R, G, B
define('COLOR_CANCEL','188,0,0'); // text color R, G, B

define('COLOR_LIST','0,80,30'); // text color R, G, B

define('COLOR_CHECKBOX','128,128,128'); // checkbox border color R, G, B

//nexstar logo position
define('NEXSTAR_LOGO_X',28);
define('NEXSTAR_LOGO_Y',834);

//where to start text blocks
define('LEFT_MARGIN',32);
define('TOP_MARGIN',200); //for text, not top box
