...
//colors
define('COLOR_TOP_TITLE','214,3,7'); // top box title color R, G, B
define('COLOR_TOP_TEXT','1,2,3'); // top box text color R, G, B

define('COLOR_TITLE','251,63,3'); // title color R, G, B
...
define('TOP_MARGIN',246); //for text, not top box
...
define('PHOTO_BOX','430,240,125,175');
