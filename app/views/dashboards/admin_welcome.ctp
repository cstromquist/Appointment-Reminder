...
<ol>
	<li><?php echo $html->link('Edit your company settings', array('controller' => 'companies', 'action' => 'edit', '?' => 'redirect=' . '/admin/dashboards/welcome/')); ?><?php if($companycheck): ?> <?php echo $html->image('icon-green-checkmark.png'); ?><?php endif; ?>
		<ul>
			...
			<li>Add your company payment methods.<?php if($haspaymentmethods): ?> <?php echo $html->image('icon-green-checkmark.png', array('height' => 15)); ?><?php endif; ?></li>
	...
	<li><?php echo $html->link('Send your first email!', array('controller' => 'reminders', 'action' => 'index')); ?><?php if($reminderscheck): ?> <?php echo $html->image('icon-green-checkmark.png'); ?><?php endif; ?></li>
</ol>