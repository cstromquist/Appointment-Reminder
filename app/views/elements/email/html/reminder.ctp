...
<html>
	<body style="text-align: center; background-color: #aeaeae;">
		<div style="text-align: center;">
			...
			<?php endif; ?>
			<p>Can't view this email? <?php echo $html->link("Click here to view it in your web browser.", FULL_BASE_URL . '/img/uploads/reminders/'.$reminder['Reminder']['image_path']); ?></p>
		</div>
	</body>
</html>